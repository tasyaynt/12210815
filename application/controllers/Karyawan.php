...
class Karyawan extends CI_Controller{
    ...
    function tambah_aksi() {
        ...
        $this->Karyawan_model->input_data($data,'table_12210815');
    ...
    function edit ($id) {
        $where = array('id' => $id);
        $data['karyawan'] = $this->Karyawan_model->edit_data($where,'table_12210815')->result();
        $data['status'] = ['Menikah','Belum Menikah'];
        $data['jabatan'] = ['Direktur','Manager','Staff'];
    ...
    function update() {
        ...
        $this->Karyawan_model->update_data($where,$data,'table_12210815');
        redirect('karyawan/index');
    } 

    function hapus ($id) {
        $where = array('id' => $id);
        $this->Karyawan_model->hapus_data($where,'table_12210815');
        redirect('karyawan/index');
    }
}